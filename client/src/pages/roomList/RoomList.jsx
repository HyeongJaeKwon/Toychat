...
const RoomList = ({ user, setUser, menuInfo, setMenuInfo}) => {
  ...
  /**Creating Chat Room feature will be on Friends.jsx */
  ...
  return (
    <div className="rContainer">
      ...
      <RoomContainer user ={user} setUser={setUser}  menuInfo={menuInfo} setMenuInfo={setMenuInfo}/>
    </div>
  );
};
